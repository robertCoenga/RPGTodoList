      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {displayProjects.map((project) => (
            <div key={project.id} className="bg-slate-800/50 border border-cyan-500/20 rounded-lg p-3">
      ...
      <div>
        ...
        <div className="space-y-2">
          {displayHabits.map((habit) => (
            <div key={habit.id} className="flex items-center justify-between bg-slate-800/50 border border-cyan-500/20 rounded-lg p-3">
              ...
              <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                <span className="text-xs font-mono text-yellow-300">🔥 {habit.streak}</span>
              </div>
            </div>
          ))}
        </div>
