        ...
        <div className="p-8">
                ...
                {metasData.map((meta, index) => (
                  <div key={index}>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-mono text-slate-300">{meta.name}</span>
                      <span className="text-sm font-mono text-cyan-300 font-bold">{meta.value}%</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {habitosData.map((habito, index) => (
                <div key={index} className="bg-slate-800/50 border border-cyan-500/20 rounded-lg p-4 text-center">
                  <h3 className="text-sm font-mono text-slate-300 mb-3">{habito.name}</h3>
                  <div className="mb-3">
                    <div className="text-2xl font-bold text-cyan-400">{habito.porcentagem}%</div>
                  </div>
            ...
            <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-6 neon-glow-cyan">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="bg-gradient-to-br from-green-900/30 to-green-900/10 border border-green-500/30 rounded-lg p-4 text-center">
                  <p className="text-xs font-mono text-green-300 uppercase mb-2">Ganho</p>
                ...
                <div className="bg-gradient-to-br from-red-900/30 to-red-900/10 border border-red-500/30 rounded-lg p-4 text-center">
                  <p className="text-xs font-mono text-red-300 uppercase mb-2">Gasto</p>
                ...
                <div className="bg-gradient-to-br from-yellow-900/30 to-yellow-900/10 border border-yellow-500/30 rounded-lg p-4 text-center">
                  <p className="text-xs font-mono text-yellow-300 uppercase mb-2">Saldo</p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-6 text-center">
              ...
              <p className="text-xs font-mono text-slate-500 uppercase mb-2">Projetos Ativos</p>
            ...
            <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-6 text-center">
              ...
              <p className="text-xs font-mono text-slate-500 uppercase mb-2">Metas Ativas</p>
            ...
            <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-6 text-center">
              ...
              <p className="text-xs font-mono text-slate-500 uppercase mb-2">Hábitos Ativos</p>
            ...
            <div className="bg-slate-900/50 border border-cyan-500/30 rounded-lg p-6 text-center">
              ...
              <p className="text-xs font-mono text-slate-500 uppercase mb-2">Saldo Anual</p>
