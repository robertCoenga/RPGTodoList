...
export default function Lobby() {
  ...
  return (
    <div className="flex bg-black/40 items-center justify-center h-full w-full  max-w-screen overflow-hidden max-h-screen">
      <div className=" flex flex-row max-h-screen min-h-180 max-w-400 gap-8 p-10 items-center border-2 bg-[#1b1b1b] border-gray-600 rounded-2xl">
        <div className="flex flex-col gap-13 px-2" id="character-menu-left">
          <ExpandableButton
            buttonPosition="left"
            margin=""
            color="#be002a"
            icon={
              <GiSeaSerpent className="text-gray-600 max-h-20 max-w-20 min-h-15 min-w-15 h-full w-full hover:text-[#be002a]" />
            }
            title="Quest"
          >
            <DayDetailModal
          ...
          <ExpandableButton
            ...
            color="#ad0a4e"
            icon={
              <GiDoubleDragon className=" text-gray-600 max-h-20 max-w-20 min-h- min-w-15 h-full w-full hover:text-[#ad0a4e]" />
            }
            title="Quest Semanal"
          >
            <div className="w-2xl">
          ...
          <ExpandableButton
            ...
            color="#760a91"
            icon={
              <GiHydra className="text-gray-600 max-h-20 max-w-20 min-h- min-w-15 h-full w-full hover:text-[#760a91]" />
            }
            title="Temporada"
          >
            <div className="w-3xl">
        ...
        <div className="flex flex-col gap-5" id="game-presentation">
          <h1 className="text-amber-400 text-5xl w-full text-center">
            RPG-LIFE
          </h1>
          <div
            className=" rounded-md bg-gray-600 p-2 flex flex-col max-w-150"
            id="character"
          >
            <Image
            ...
            />
            <div
              className="flex flex-row bg-gray-800 border-t-6 border-gray-600 gap-2"
              id="statics"
            >
          ...
          <div
            ...
            id="game-options"
          >
            <button className="rounded-md bg-green-300 text-white p-2 w-25">
              Start
            </button>
            <button className="rounded-md bg-red-400 text-white p-2 w-25">
              Inventari
            </button>
          </div>
        </div>
        ...
        <div
          className="flex flex-col items-center gap-13  px-2"
          id="character-menu-right"
        >
          <ExpandableButton
            ...
            color="#6bd1ce"
            icon={
              <GiFreedomDove className="text-gray-600 max-h-20 max-w-20 min-h- min-w-15 h-full w-full hover:text-[#6bd1ce]" />
            }
            title="Sonhos"
          >
            <h1>Sonhos</h1>
          ...
          <ExpandableButton
            ...
            color="#0d53bd"
            icon={
              <GiWilliamTellSkull className="text-gray-600 max-h-20 max-w-20 min-h- min-w-15 h-full w-full hover:text-[#0d53bd]" />
            }
            title="Metas"
          >
            <div className="w-xl">
          ...
          <ExpandableButton
            ...
            color="#401d85"
            icon={
              <GiBurningBook className="text-gray-600 max-h-20 max-w-20 min-h- min-w-15 h-full w-full hover:text-[#401d85]" />
            }
            title="Projetos"
          >
            <div className="w-xl">
